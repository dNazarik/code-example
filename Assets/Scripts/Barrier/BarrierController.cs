...
namespace Barrier
{
	public class BarrierController
	{
		...
		private BlockController[] CreateBlocks(ICommonFactory factory, GameConfig config, Transform parent,
			IReadOnlyList<Vector3> positions, Vector2Int[] gapsCoordinates)
		{
			...
			//var possibleRadiuses = _model.GetGapsMaximumRadius(gapsCoordinates);

			for (var i = 0; i < blocks.Length; i++)
			{
				var coordinates = new Vector2Int(xCounter, yCoordinate);
