...
namespace Core
{
    public static class Extensions
    {
        ...
        public static Vector2Int NumberToMatrixPos(int num, int extent) {
            return new Vector2Int(num % extent, num / extent);
        }

        public static int MatrixPosToNumber(Vector2Int vector, int extent) {
            return vector.y * extent + vector.x;
        }
